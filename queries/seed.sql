...
INSERT INTO user_profile (user_profile_id, user_profile_name, user_profile_role, user_auth_id) VALUES
  (1, 'Alice Martin', 'manager', 1),
  (2, 'Bob Finch', 'speaker', 2),
  (3, 'Carol Dupont', 'display_operator', 3),
  (4, 'Dave Leroy', 'speaker', 4);

INSERT INTO event (event_id, event_name, event_description, start_at, end_at, user_profile_id) VALUES
...
INSERT INTO activity (activity_id, activity_name, activity_description, activity_start, activity_end, activity_real_start, activity_real_end, ref_event_id, room_id) VALUES
...
INSERT INTO activity (activity_id, activity_name, activity_description, activity_start, activity_end, ref_event_id, room_id, capacity) VALUES
